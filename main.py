...
from trader import iniTrader, RuleTrader, SmartTrader, TieredTrader, HillTrade, JackTrader, LTrader, RandTrader, PredTrader, InsiderTrader
...
RSI_Trader,Adv_Trader,Hill_Trader,Variable_Trader,Tiered_Trader,AntiRSI_Trader,Random_Trader,Pred_Trader,Insider_Trader,Sum,Diff,cols,cols2,cols3 = iniTrader('RSI_Trader','Adv_Trader','Hill_Trader','Variable_Trader','Tiered_Trader','AntiRSI_Trader','Random_Trader','Pred_Trader','Insider_Trader')

#%%
def main():
    for t in range (buffer, buffer + 3000):
       ...
       #Prediction Only Trading: 
        ...
        summarize(Sum,RSI_Trader,Adv_Trader,Hill_Trader,Variable_Trader,Tiered_Trader,AntiRSI_Trader,Random_Trader,Pred_Trader,Insider_Trader,t,Hist[t,:],cols2)
        if t%1000 == 0:
            print (Sum.table)
...
#%%
#Plot stuff.
Plotter(Sum,buffer,dfBTC,dfETH,dfLTC,RSI_Trader,Adv_Trader,Hill_Trader,Variable_Trader,Tiered_Trader,AntiRSI_Trader,Random_Trader,Insider_Trader)
